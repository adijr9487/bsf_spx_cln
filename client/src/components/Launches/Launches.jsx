...
// https://api.mapbox.com/styles/v1/mapbox/dark-v11/static/-118.2589,33.7322,13,0/300x200@2x?access_token=pk.eyJ1IjoiYWRpanI5NDg3IiwiYSI6ImNsa3lvd3A2MzB2Z3gzZW4wemppODNkbnkifQ.ntYqIZEZDpXB3LdGkY7o_w
...
let temp_data = [
  ...
  },
  {
    ...
    successful_landings: 1,
    wikipedia:
      "https://en.wikipedia.org/wiki/Vandenberg_AFB_Space_Launch_Complex_4#LZ-4_landing_history",
    details:
        ...
        <div className="additional flex justify-between pt-4">
          <div className="status">
            <h4 className="text-sm" style={{
              color: data.status === 'active' ? '#2BEE99' : (data.status === 'retired' ? 'grey' : '#CCEE2B')
            }}>
          ...
          >
            ...
            <div className="flex flex-col">
              <p>{data.successful_landings}</p>
              <p>{data.attempted_landings}</p>
            </div>
          </div>
        </div>
      </div>
